...
<div class="py-2" style="background-color: rgb(84 152 209);">
</div>

<!-- Barra de redes sociales en la parte superior -->
...
<nav class="navbar navbar-expand-lg" style="background-color: #16171a;">
    <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation" style="background-color: white; border: none;">
